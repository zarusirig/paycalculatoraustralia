...
export const NEWS_ARTICLES: NewsArticleMeta[] = [
  ...
  },
  {
    ...
    faq: [
      { question: "What is the HECS repayment threshold for 2026-27?", answer: "The minimum repayment threshold for FY2026-27 is $69,528. Below that repayment income, you make no compulsory HECS or HELP repayment. It's indexed up from $67,000 in FY2025-26, the year the marginal repayment system launched with a raised $54,435-to-$67,000 jump." },
      { question: "What happens once I earn over $69,528?", answer: "Under the marginal system, you pay 15c for every dollar of repayment income above $69,528, up to $129,717. Above that, repayments are $9,028 plus 17c per dollar up to $186,050, and 10% of total repayment income above $186,050." },
