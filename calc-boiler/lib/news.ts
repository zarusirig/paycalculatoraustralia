...
export const NEWS_ARTICLES: NewsArticleMeta[] = [
  ...
  {
    slug: "centrelink-payment-increase-january-2026",
    headline: "Centrelink Payments Rise From 1 January: Who Gets More",
    title: "Centrelink Payments Rise From 1 January 2026: Who Gets More",
    description: "Youth Allowance, Austudy and ABSTUDY rose to $677.20 a fortnight and Carer Allowance to $162.60 from 1 January 2026, reaching over 1 million Australians.",
    ...
    relatedArticles: ["age-pension-increase-march-2026", "centrelink-changes-july-2026"],
    sources: [
      { title: "Changes to social security payments from 1 January", url: "https://ministers.dss.gov.au/media-releases/18636", publisher: "Department of Social Services Ministers" },
      { title: "Rates list — 1 January 2026", url: "https://www.dss.gov.au/system/files/documents/2025-12/rates-list-1-january-2026.pdf", publisher: "Department of Social Services" },
    ],
    faq: [
      { question: "What Centrelink payments increased on 1 January 2026?", answer: "Youth Allowance, Austudy, ABSTUDY and Carer Allowance all rose on 1 January 2026 as part of the standard indexation cycle. Youth Allowance and Austudy single rates away from home rose to $677.20 a fortnight, and ABSTUDY's independent single rate matched it, while Carer Allowance rose to $162.60 a fortnight." },
      { question: "How much did Youth Allowance and Austudy go up by?", answer: "The single, away-from-home maximum basic rate for Youth Allowance and Austudy rose by $13.90 a fortnight, taking it to $677.20. The exact increase for other categories — such as living at home or with dependents — varies, so check your own rate on your Centrelink online account." },
      { question: "Who gets the Carer Allowance increase?", answer: "Around 680,000 Carer Allowance recipients received the 1 January 2026 increase, taking the fortnightly rate to $162.60, up $3.30. Carer Allowance is a supplementary payment and can be received alongside Carer Payment or while working, unlike most other Centrelink income-support payments." },
      { question: "Did Age Pension or JobSeeker also rise on 1 January?", answer: "No. Age Pension, JobSeeker and other pension-type payments are indexed twice a year, on 20 March and 20 September, not 1 January. The January indexation round covers student and youth payments plus Carer Allowance, which follow a separate CPI-linked cycle." },
    ],
  },
  {
    slug: "age-pension-increase-march-2026",
    headline: "Age Pension Rises $22.20 a Fortnight From 20 March 2026",
    title: "Age Pension Rises $22.20 a Fortnight From 20 March 2026",
    ...
    relatedArticles: ["deeming-rates-change-2026", "centrelink-payment-increase-january-2026"],
    sources: [
      { title: "Changes to social security payments from March 20", url: "https://ministers.dss.gov.au/media-releases/18736", publisher: "Department of Social Services Ministers" },
      { title: "Age Pension rates", url: "https://www.servicesaustralia.gov.au/how-much-age-pension-you-can-get?context=22526", publisher: "Services Australia" },
    ],
    faq: [
      { question: "How much did the Age Pension increase on 20 March 2026?", answer: "The maximum full Age Pension rose $22.20 a fortnight for singles, taking it to $1,200.90, and $33.40 combined for couples, taking each partner's payment to $905.20. These rates apply from 20 March 2026 until the next indexation on 20 September 2026." },
      { question: "Do the Disability Support Pension and Carer Payment get the same rise?", answer: "Yes. The Disability Support Pension and Carer Payment are paid at the same maximum rate as the Age Pension, so both rose to $1,200.90 a fortnight for singles and $905.20 each for couples from 20 March 2026, under the same twice-yearly indexation cycle." },
      { question: "Why does the Age Pension increase twice a year?", answer: "Age Pension and related pension-type payments are indexed every 20 March and 20 September, using the higher of the Consumer Price Index or Pensioner and Beneficiary Living Cost Index, then benchmarked against a percentage of Male Total Average Weekly Earnings to protect purchasing power." },
      { question: "Does the pension increase change the income and assets tests?", answer: "The income and assets test thresholds are also indexed on 20 March and 20 September, usually rising alongside the payment rate. Check the current cut-off points on your Centrelink online account, since higher thresholds can mean some part-pensioners become eligible for a larger payment." },
    ],
  },
  {
    slug: "deeming-rates-change-2026",
    headline: "Deeming Rates Change: How Centrelink Now Counts Your Savings",
    title: "Deeming Rates Change 2026: How Centrelink Counts Savings",
    description: "From 20 March 2026, Centrelink deeming rates rose to 1.25% below $64,200 (singles) or $106,200 (couples), 3.25% above, changing how savings count for pensions.",
    category: "Centrelink & Payments",
    datePublished: "2026-03-20",
    dateModified: "2026-07-02",
    authorId: "penny-ward",
    ...
    relatedArticles: ["age-pension-increase-march-2026", "centrelink-changes-july-2026"],
    sources: [
      { title: "Deeming rate recommendation — March 2026", url: "https://aga.gov.au/publications/deeming-rates/recommendation-march-2026", publisher: "Australian Government Actuary" },
      { title: "Deeming — Age Pension", url: "https://www.servicesaustralia.gov.au/deeming?context=22526", publisher: "Services Australia" },
    ],
    faq: [
      { question: "What are the new deeming rates from 20 March 2026?", answer: "The lower deeming rate rose to 1.25% and the upper rate to 3.25% from 20 March 2026, on the recommendation of the Australian Government Actuary. This ended a multi-year freeze at 0.25% and 2.25% that had applied since May 2020 to support pensioners through low interest rates." },
      { question: "What are the deeming thresholds for singles and couples?", answer: "The 1.25% lower rate applies to financial assets up to $64,200 for a single person, or $106,200 combined for a couple with at least one member on a pension. Financial assets above those thresholds are deemed to earn income at the higher 3.25% rate." },
      { question: "What counts as a financial asset for deeming?", answer: "Financial assets include bank accounts, term deposits, shares, managed funds and superannuation balances for people who have reached Age Pension age. Centrelink assumes these assets earn the deemed rate of income regardless of what they actually earn, and counts that toward your income test." },
      { question: "Why did deeming rates go up in 2026?", answer: "Deeming rates are meant to reflect returns available on standard, low-risk investments such as savings accounts. The Australian Government Actuary recommended lifting rates from their pandemic-era freeze as interest rates on savings accounts rose, though the new rates remain below long-term historical averages." },
    ],
  },
  {
    slug: "centrelink-changes-july-2026",
    headline: "Centrelink Changes From 1 July: Family Payments and Higher Limits",
    title: "Centrelink Changes July 2026: Family Payment Increases",
    description: "From 1 July 2026, Family Tax Benefit Part A rose to $235.48 a fortnight per child under 13, Part B to $200.34, and the Part B income limit lifted to $124,327.",
    category: "Centrelink & Payments",
    datePublished: "2026-07-01",
    dateModified: "2026-07-02",
    authorId: "penny-ward",
    ...
    relatedArticles: ["july-1-2026-money-changes", "centrelink-payment-increase-january-2026"],
    sources: [
    ...
    faq: [
      ...
      { question: "Did the Family Tax Benefit income limits also rise?", answer: "Yes. The Family Tax Benefit Part B primary earner income limit rose to $124,327 for 2026-27 — above that, a family isn't eligible for Part B at all. Part A income-free areas and taper thresholds were also indexed, following the standard annual 1 July cycle for family assistance payments." },
      { question: "Why are family payments indexed on 1 July, not March?", answer: "Family Tax Benefit and related family assistance payments run on the financial year and are indexed each 1 July, unlike pension-type payments such as Age Pension and JobSeeker, which are indexed every 20 March and 20 September on a separate, calendar-based cycle." },
