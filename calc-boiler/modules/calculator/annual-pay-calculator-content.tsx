// Everything on /annual-pay-calculator/ below the calculator card: worked
// example, hourly and salary tables, FY changes, FAQ and sources. A server
// component, so it ships as HTML; annual-pay-calculator.tsx (client) renders it
// via `children`.
...
export default function AnnualPayCalculatorContent() {
  return (
    <>
