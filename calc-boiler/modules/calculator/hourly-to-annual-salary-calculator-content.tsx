// Everything on /hourly-to-annual-salary-calculator/ below the calculator card:
// hours in a year, worked examples, conversion tables, minimum wage, FAQ and
// sources. A server component, so it ships as HTML;
// hourly-to-annual-salary-calculator.tsx (client) renders it via `children`.
...
/** Same example rate as HEADLINE_RATE in hourly-to-annual-salary-calculator.tsx and app/hourly-to-annual-salary-calculator/page.tsx — keep all three in step. */
...
export default function HourlyToAnnualSalaryCalculatorContent() {
  return (
    <>
        {/* CONTENT */}
