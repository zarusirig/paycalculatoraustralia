// Everything on /pay-rise-calculator/ below the calculator card: worked
// examples, impact tables, negotiation tips, FAQ and sources. A server
// component, so it ships as HTML; pay-rise-calculator.tsx (client) renders it
// via `children`.
...
export default function PayRiseCalculatorContent() {
  return (
    <>
        {/* CONTENT */}
