            ...
            <section>
              ...
              <Accordion type="multiple" className="space-y-3">
                ...
                <AccordionItem value="conversion" className="rounded-xl border border-sandstone-dark/20 px-5">
                  ...
                  <AccordionContent><p className="text-warmgray">Yes. Since 26 August 2024, a casual employee who has worked for their employer for at least <strong>6 months (12 months if the employer is a small business with fewer than 15 employees)</strong> and believes they no longer meet the casual definition can notify their employer that they want to change to full-time or part-time. The employer must respond in writing within 21 days; employers are no longer required to offer conversion.</p></AccordionContent>
                </AccordionItem>
