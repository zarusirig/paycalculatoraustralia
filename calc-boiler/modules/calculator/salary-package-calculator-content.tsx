// The static long-form content on /salary-package-calculator/. A server
// component, so it ships as HTML; the client module
// (salary-package-calculator.tsx) renders it via `children` below the
// calculator card.
...
// Same as takeHome in salary-package-calculator.tsx (duplicated so this server
// file imports nothing from the client module).
function takeHome(base: number) {
  return calculatePayBreakdown({ grossSalary: base });
}

export default function SalaryPackageCalculatorContent() {
