// Everything on /hecs-help-calculator/ below the calculator card: rates and
// thresholds, loan schemes, worked examples, indexation, FAQ and sources. A
// server component, so it ships as HTML; hecs-help-calculator.tsx (client)
...
import type { CalculatorFaq } from "@/modules/calculator/hecs-help-calculator";
...
export default function HECSHelpCalculatorContent({ faqs }: { faqs: readonly CalculatorFaq[] }) {
