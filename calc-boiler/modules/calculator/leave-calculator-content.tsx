// The static long-form content on /leave-calculator/. A server component, so it
// ships as HTML; the client module (leave-calculator.tsx) renders it via
...
export default function LeaveCalculatorContent() {
  return (
    <>
