      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section>
            ...
            <p className="text-warmgray mb-4">
              The Medicare levy is <strong>2%</strong> of your taxable income, withheld weekly. Singles with taxable income up to <strong>{formatAUD(MEDICARE_LEVY.lowIncomeThreshold)}</strong> pay no levy, and it phases in up to {formatAUD(MEDICARE_LEVY.shadeInThreshold)}. The "Medicare Levy Surcharge" (MLS) adds an additional <strong>1% to 1.5%</strong> for high earners without private hospital cover: singles earning between {formatAUD(MLS.tier1.min)} and {formatAUD(MLS.tier1.max)} pay <strong>1%</strong>, between {formatAUD(MLS.tier2.min)} and {formatAUD(MLS.tier2.max)} pay <strong>1.25%</strong>, and above {formatAUD(MLS.tier3.min - 1)} pay <strong>1.5%</strong>.
            </p>
