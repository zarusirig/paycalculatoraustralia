        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-3 text-warmgray mb-4">
              ...
              <li><strong>Using old HECS-HELP thresholds.</strong> The repayment threshold increased from $69,528 to $69,528 in FY2025-26, and the system shifted from tiered percentages to marginal rates. Using old thresholds overstates repayments for graduates earning between $69,528 and $69,528.</li>
