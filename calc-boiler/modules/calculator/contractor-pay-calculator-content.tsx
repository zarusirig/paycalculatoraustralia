// Everything on /contractor-pay-calculator/ below the hero calculator: key
// features, how contractor pay works, day-rate and rate-to-salary tables, FAQ
// and sources. A server component, so it ships as HTML;
// contractor-pay-calculator.tsx (client) renders it via `children`.
...
export default function ContractorPayCalculatorContent() {
  return (
    <>
      {/* Content sections */}
