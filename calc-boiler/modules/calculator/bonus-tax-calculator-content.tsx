// Everything on /bonus-tax-calculator/ below the calculator card: worked
// examples, bracket tables, strategies, FAQ and sources. A server component, so
// it ships as HTML; bonus-tax-calculator.tsx (client) renders it via `children`.
...
export default function BonusTaxCalculatorContent() {
  return (
    <>
        {/* CONTENT */}
