...
export default function SuperTaxChangesExplained() {
  return (
    <>
      ...
      <p>
        Payday super requires employers to pay super guarantee with every pay run and get it into
        your fund within 7 business days, replacing the old quarterly payment cycle. It doesn&apos;t
        change your super rate, but it does mean your contributions start earning returns sooner —
        and it gives the ATO much faster visibility into employers who fall behind.
      </p>
      ...
      <p>
        ...
        existing high-income super settings.
      </p>
      ...
      <p>
        ...
        super guarantee eroding workers&apos; balances over time.
      </p>
      ...
      <p>
        ...
        salary sacrifice or after-tax contributions before hitting a cap.
      </p>
