...
function restaurant(): AwardPageCopy {
  ...
  return {
    ...
    title: `Restaurant Award Pay Rates ${FY} (${a.meta.code}) — Casual, Sunday & Junior Rates`,
    description: `Restaurant Industry Award rates from ${a.meta.operativeFrom}: Level 1 ${$(l1.hourly)}/hr (${$(casual(a, l1.hourly))} casual), cook grade 3 ${$(l4.hourly)}, chef de partie ${$(l6.hourly)}. Weekend, late-night and public holiday rates, junior rates and allowances.`,
...
function nurses(): AwardPageCopy {
  ...
  return {
    ...
    title: `Nurses Award Pay Rates ${FY} (${a.meta.code}) — RN, EN & Aged Care Nurse Rates`,
    description: `Nurses Award 2020 rates: registered nurse level 1 from ${$(rn1.hourly)}/hr (${$(rn1.weekly)}/wk), enrolled nurse from ${$(en1.hourly)}, aged care RN from ${$(acRn1.hourly)} after the 1 August 2026 increase. Shift, weekend and casual rates, and how the award compares with state public hospital agreements.`,
...
function agedCare(): AwardPageCopy {
  ...
  return {
    ...
    title: `Aged Care Award Pay Rates ${FY} (${a.meta.code}) — Personal Care Worker Rates`,
    description: `Aged Care Award rates from ${a.meta.operativeFrom}: direct care (personal care worker) ${$(dc1.hourly)}–${$(dc6.hourly)}/hr, general staff ${$(g1.hourly)}–${$(g7.hourly)}. Casual, shift, weekend and public holiday rates, overtime and allowances, after the aged care work value increases.`,
...
function hairAndBeauty(): AwardPageCopy {
  ...
  return {
    ...
    title: `Hair and Beauty Award Pay Rates ${FY} (${a.meta.code}) — Hairdresser & Beauty Therapist Rates`,
    description: `Hair and Beauty Industry Award rates from ${a.meta.operativeFrom}: Level 1 ${$(l1.hourly)}/hr (${$(casual(a, l1.hourly))} casual) to Level 6 ${$(l6.hourly)}. Saturday 133%, Sunday 200%, junior rates for under-18s and allowances.`,
...
function cleaning(): AwardPageCopy {
  ...
  return {
    ...
    title: `Cleaning Award Pay Rates ${FY} (${a.meta.code}) — Full-time, Part-time & Casual Rates`,
    description: `Cleaning Services Award rates from ${a.meta.operativeFrom}: Level 1 ${$(l1.hourly)}/hr full-time, ${$(pt(l1.hourly))} part-time (15% allowance), ${$(casual(a, l1.hourly))} casual. Night shift, weekend and public holiday rates, minimum shift lengths and allowances.`,
...
function roadTransport(): AwardPageCopy {
  ...
  return {
    ...
    title: `Road Transport Award Pay Rates ${FY} (${a.meta.code}) — Truck Driver Grades 1–10`,
    description: `Road Transport and Distribution Award rates from ${a.meta.operativeFrom}: Grade 1 ${$(g1.hourly)}/hr to Grade 10 ${$(g10.hourly)}/hr — semi-trailer (Grade 6) ${$(g6.hourly)}, B-double (Grade 7) ${$(g7.hourly)}. Shift, weekend, public holiday and casual overtime rates, junior rates and allowances.`,
