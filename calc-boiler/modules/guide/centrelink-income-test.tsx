...
{/* ── Calculators (added 2026-08-28: spokes for the payment types this hub was catching) ── */}
          <section>
            ...
            <div className="not-prose my-6 rounded-xl border border-ochre/40 bg-ochre/10 p-4 text-sm text-navy">
              <strong>Rates change on 20 September 2026.</strong> JobSeeker and the pensions are indexed on 20 March and 20 September, so the figures on this page are given twice: what is paid <em>now</em>, to 19 September 2026, and what is paid <em>from</em> 20 September 2026 (DSS rates list, published {CENTRELINK_SOURCES.dssRatesListPublished}). Single JobSeeker goes {formatAUD(JS_MAR.maxFortnightly.single, 2)} &rarr; {formatAUD(JS_SEP.maxFortnightly.single, 2)} a fortnight and the single Age Pension {formatAUD(AP_MAR.maxFortnightly.single.total, 2)} &rarr; {formatAUD(AP_SEP.maxFortnightly.single.total, 2)}. The two calculators above apply whichever set is in force on the day you open them. Student payments &mdash; Austudy and Youth Allowance &mdash; index on 1 January and do not change in September.
            </div>
          </section>
...
{/* ── H2: Current rates and indexation dates — from constants, replaces the FY2025-26 "what changed" table ── */}
          <section>
            ...
            <p className="text-warmgray mb-4">JobSeeker and pension rates move on 20 March and 20 September; student payments on 1 January. The middle column is what is paid now, to 19 September 2026; the last column is the <strong>20 September 2026</strong> indexation, published in the DSS rates list on {CENTRELINK_SOURCES.dssRatesListPublished} and verified here on {CENTRELINK_SOURCES.verifiedOn}. Keep the March figures for any payslip or Centrelink letter dated before 20 September.</p>
