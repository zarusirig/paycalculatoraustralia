...
{/* ── H2: Current rates and indexation dates — from constants, replaces the FY2025-26 "what changed" table ── */}
          <section>
            ...
            {/* J6: link to the single all-payments table */}
            <p className="text-warmgray mb-4">Every payment&rsquo;s current rate is on one page in our <Link href="/centrelink-payment-rates/" className="text-eucalyptus-dark hover:underline font-medium">Centrelink payment rates table</Link>.</p>
