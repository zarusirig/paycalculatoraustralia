            ...
            <section id="faq">
              ...
              <Accordion type="multiple" className="not-prose mt-6 space-y-3">
                ...
                <AccordionItem value="how-long" className="border rounded-lg px-4 bg-white">
                  ...
                  <AccordionContent className="text-warmgray">Electronic lodgements through myTax or a tax agent are typically processed within <strong>2 weeks</strong>. Paper returns: most refunds issue within <strong>{RETURN_2026.paperRefundBusinessDays} business days</strong>. Complex returns that require manual review may take longer. You can check the status of your return through your myGov account.</AccordionContent>
                </AccordionItem>
