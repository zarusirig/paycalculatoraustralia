            ...
            <section id="faq">
              ...
              <Accordion type="multiple" className="not-prose mt-6 space-y-3">
                ...
                <AccordionItem value="convert" className="border rounded-lg px-4 bg-sandstone bg-white">
                  ...
                  <AccordionContent className="text-navy">
                    Divide your annual salary by 52 weeks, then divide by your standard weekly hours (38 for full-time). For example: $75,000 / 52 / 38 = $37.96 per hour. Use our <Link href="/hourly-to-annual-salary-calculator/" className="text-eucalyptus-dark hover:underline">Hourly to Annual Salary Calculator</Link> for an instant conversion with tax and super included.
                  </AccordionContent>
                </AccordionItem>
