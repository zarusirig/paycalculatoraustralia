...
import { RADIOGRAPHER } from "@/lib/data/job-pay-rates/radiographer"; // G3
                ...
                <div className="overflow-hidden rounded-xl border border-sandstone-dark/20 shadow-sm">
                  <table className="w-full text-sm text-left text-warmgray">
                    ...
                    <tbody className="divide-y divide-sandstone-dark/20 bg-white">
                      ...
                      {/* G3 (wave 4): allied health on the same award, degree-entry pay point 2 */}
                      <tr><td className="px-5 py-3"><Link href="/job-pay-rates/radiographer/" className="text-eucalyptus-dark hover:underline">Radiographer</Link> / <Link href="/job-pay-rates/sonographer/" className="text-eucalyptus-dark hover:underline">sonographer</Link> — graduate award minimum / median<span className="block text-xs text-warmgray-light">Health Professionals Award level 1 pay point 2; JSA median, medical imaging professionals</span></td><td className="px-5 py-3 text-right font-medium">{formatAUD(rowAnnual(headlineRow(RADIOGRAPHER)!))} / {formatAUD(medianAnnual(RADIOGRAPHER))}</td></tr>
                      <tr><td className="px-5 py-3"><Link href="/job-pay-rates/speech-pathologist/" className="text-eucalyptus-dark hover:underline">Speech pathologist</Link> / <Link href="/job-pay-rates/audiologist/" className="text-eucalyptus-dark hover:underline">audiologist</Link> — graduate award minimum / median<span className="block text-xs text-warmgray-light">Health Professionals Award level 1 pay point 2; JSA median. Also: <Link href="/job-pay-rates/podiatrist/" className="text-eucalyptus-dark hover:underline">podiatrist</Link>, <Link href="/job-pay-rates/dietitian/" className="text-eucalyptus-dark hover:underline">dietitian</Link></span></td><td className="px-5 py-3 text-right font-medium">{formatAUD(rowAnnual(headlineRow(SPEECH_PATHOLOGIST)!))} / {formatAUD(medianAnnual(SPEECH_PATHOLOGIST))}</td></tr>
