                ...
                <div className="overflow-hidden rounded-xl border border-sandstone-dark/20 shadow-sm">
                  <table className="w-full text-sm text-left text-navy">
                    ...
                    <tbody className="divide-y divide-sandstone-dark/20 bg-white">
                      ...
                      <tr className="bg-eucalyptus/5 font-medium"><td className="px-5 py-3">FY2025-26</td><td className="px-5 py-3">3.75%</td><td className="px-5 py-3">$24.10</td><td className="px-5 py-3">$915.91</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
