// The static long-form content on /employer-cost-calculator/: the guide
// article (`children`) and the sidebar (`sidebar`). Server components, so they
// ship as HTML; the client module (employer-cost-calculator.tsx) keeps only the
// breadcrumbs, hero and the interactive calculator.
...
export default function EmployerCostCalculatorContent() {
...
export function EmployerCostCalculatorSidebar() {
  return (
