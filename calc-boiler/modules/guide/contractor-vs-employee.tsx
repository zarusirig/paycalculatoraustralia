          ...
          <article className="lg:w-2/3 prose prose-blue prose-lg max-w-none prose-headings:text-navy prose-a:text-eucalyptus-dark hover:prose-a:text-navy">
            ...
            <section id="fy2025-26-changes">
              ...
              <ul>
                ...
                <li><strong>Maximum super contribution base:</strong> From 1 July 2026 this is an <strong>annual</strong> figure of <strong>$270,830</strong>, replacing the old quarterly cap of $62,500 that applied up to 30 June 2026. Note it is not a conversion of the quarterly figure — it is derived as the concessional cap × 100 ÷ 12. Employers stop paying SG once an employee has been paid $270,830 of qualifying earnings for the year, which for FY2025-26 equated to an annual salary of $250,000.</li>
              </ul>
              <p>
            ...
            <section id="faq">
              ...
              <Accordion type="multiple" className="not-prose mt-6 space-y-3">
                ...
                <AccordionItem value="fy-changes" className="border rounded-lg px-4 bg-sandstone bg-white">
                  ...
                  <AccordionContent className="text-navy">
                    The Super Guarantee rate increased to <strong>12%</strong> (from 11.5%), the concessional super cap is <strong>$32,500</strong> from 1 July 2026 (up from $30,000), and the maximum super contribution base is now <strong>$270,830 a year</strong> rather than $62,500 a quarter. The Stage 3 income tax cuts remain in effect, with the 30% bracket applying from $45,001 to $135,000. The HECS-HELP minimum repayment threshold rose to <strong>$69,528</strong> under the new marginal system.
                  </AccordionContent>
                </AccordionItem>
