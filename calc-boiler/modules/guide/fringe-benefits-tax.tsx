      ...
      <div className="flex flex-col lg:flex-row gap-12">
        <article className="lg:w-2/3 prose prose-lg max-w-none prose-headings:text-navy prose-a:text-eucalyptus-dark">
          ...
          <section>
            ...
            <p>Some employers pass the cost of FBT to employees through &quot;employee contribution&quot; arrangements. An employee can make after-tax contributions toward the cost of the benefit, which reduces the taxable value and therefore the FBT liability. This is common with novated leases and salary sacrifice arrangements. Employees considering salary packaging should review our <Link href="/salary-sacrifice-calculator/">Salary Sacrifice Guide</Link> to understand how employee contributions reduce FBT exposure.</p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li><Link href="/salary-sacrifice-calculator/">Salary Sacrifice Guide</Link> &mdash; salary packaging strategies for super contributions, cars, and other benefits</li>
        ...
        <aside className="lg:w-1/3"><div className="sticky top-8 space-y-6"><Card className="bg-sandstone border-sandstone-dark/20"><CardContent className="p-6"><h3 className="font-bold text-navy mb-3">Related</h3><div className="space-y-3"><SidebarLink href="/novated-lease-guide/" label="Novated Lease Guide" /><SidebarLink href="/salary-sacrifice-calculator/" label="Salary Sacrifice Guide" /><SidebarLink href="/salary-sacrifice-calculator/" label="Salary Sacrifice Calculator" /><SidebarLink href="/employer-cost-calculator/" label="Employer Cost Calculator" /><SidebarLink href="/superannuation-guide/" label="Superannuation Guide" /><SidebarLink href="/tax-calendar/" label="Tax Calendar" /></div></CardContent></Card></div></aside>
      </div>
    </div></div>
  );
}
