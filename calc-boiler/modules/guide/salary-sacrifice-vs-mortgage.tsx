            ...
            <section id="faq">
              ...
              <Accordion type="multiple" className="not-prose mt-6 space-y-3">
                ...
                <AccordionItem value="cap" className="border rounded-lg px-4 bg-sandstone bg-white">
                  ...
                  <AccordionContent className="text-navy">
                    The concessional contributions cap is <strong>{formatAUD(CAP)} per year</strong> for FY{SITE_CONFIG.financialYear}. This includes employer SG contributions and salary sacrifice. Unused cap amounts from the previous 5 financial years can be carried forward if your total super balance is under $500,000. Use the <Link href="/salary-sacrifice-calculator/" className="text-eucalyptus-dark hover:underline">Salary Sacrifice Calculator</Link> to model your specific situation.
                  </AccordionContent>
                </AccordionItem>
