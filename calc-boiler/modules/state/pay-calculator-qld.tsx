      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section>
            ...
            <p className="text-warmgray">Queensland workers in retail, hospitality, healthcare and construction are typically covered by federal modern awards that set the minimum hourly rate before tax. Our <Link href="/award-rates/" className="text-eucalyptus-dark hover:underline">Australian award rates guide</Link> lists the FY2025-26 base rates and casual loadings — the same award rates apply whether you work in Brisbane, the Gold Coast, Cairns or the Bowen Basin.</p>
          </section>
