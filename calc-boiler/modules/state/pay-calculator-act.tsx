        ...
        <section>
          ...
          <Accordion type="multiple" className="space-y-3">
            ...
            <AccordionItem value="hecs" className="rounded-xl border border-sandstone-dark/20 px-5">
              ...
              <AccordionContent><p className="text-warmgray">HECS-HELP repayments are compulsory once your repayment income exceeds <strong>$54,435</strong> for FY2025-26. The repayment rate ranges from <strong>1% to 10%</strong> of your total income. On a Canberra salary of $100,000, the HECS repayment is <strong>$4,500</strong> per year, reducing take-home pay to approximately <strong>$70,533</strong>. Use the <Link href="/hecs-help-calculator/" className="text-eucalyptus-dark hover:underline">HECS-HELP Calculator</Link> for exact figures.</p></AccordionContent>
            </AccordionItem>
