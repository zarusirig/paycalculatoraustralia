...
export const metadata: Metadata = { title: "New Job Pay Checklist — TFN, Super & Pay Setup", description: "Starting a new job? Checklist: TFN declaration, super fund choice, understanding your offer, salary negotiation and setting up your pay from day one.", alternates: { canonical: URL }, openGraph: { title: "New Job Pay Checklist Australia", description: "TFN, super & pay setup checklist for your new Australian job.", url: URL, siteName: SITE_CONFIG.name, type: "website", locale: "en_AU", images: ["/og-image.png"] }, twitter: { card: "summary_large_image", title: "New Job Pay Checklist Australia", description: "Set up your pay correctly from day one." } };
...
const faq = faqPageSchema(NEW_JOB_FAQS);
function Page() { return (<><JsonLd code={[breadcrumb, webPage, faq]} /><NewJobChecklistPage /></>); }

export default withPageEnd(Page, "/new-job-checklist/");
