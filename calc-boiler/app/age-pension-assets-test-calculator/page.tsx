...
function Page() {
  return (
    <>
      ...
      <AgePensionAssetsTestCalculatorPage afterCalculator={<WhatsNextInline route="/age-pension-assets-test-calculator/" />}><AgePensionAssetsTestCalculatorContent /></AgePensionAssetsTestCalculatorPage>
    </>
  );
}
