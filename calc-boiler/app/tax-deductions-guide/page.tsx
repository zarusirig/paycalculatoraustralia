...
export const metadata: Metadata = { title: "Tax Deductions Guide Australia 2025-26 — Work-Related Deductions Explained", description: "Complete guide to work-related tax deductions in Australia. Common deductions, how to claim, the $300 threshold, and how deductions reduce your taxable income for FY2025-26.", alternates: { canonical: URL }, openGraph: { title: "Tax Deductions Guide Australia 2025-26", description: "Complete guide to work-related tax deductions in Australia for FY2025-26.", url: URL, siteName: SITE_CONFIG.name, type: "website", locale: "en_AU" }, twitter: { card: "summary_large_image", title: "Tax Deductions Guide Australia 2025-26", description: "Work-related deductions explained for Australian taxpayers." } };
...
const webPage: WithContext<WebPage> = { "@context": "https://schema.org", "@type": "WebPage", name: "Tax Deductions Guide Australia 2025-26", url: URL, publisher: { "@type": "Organization", name: SITE_CONFIG.name } };
