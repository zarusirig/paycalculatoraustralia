...
export const metadata: Metadata = { title: "Fringe Benefits Tax (FBT) — Rate, Gross-Up & Examples", description: "Complete guide to Fringe Benefits Tax in Australia for FY2025-26. The 47% FBT rate, Type 1 (2.0802) & Type 2 (1.8868) gross-up factors, reportable benefits & employer obligations — with worked examples.", alternates: { canonical: URL }, openGraph: { title: "Fringe Benefits Tax (FBT) Australia 2025-26 — Rate, Gross-Up & Examples", description: "FBT rate, Type 1 & Type 2 gross-up factors, worked examples, reportable benefits, and employer obligations for FY2025-26.", url: URL, siteName: SITE_CONFIG.name, type: "website", locale: "en_AU", images: ["/og-image.png"] } };
