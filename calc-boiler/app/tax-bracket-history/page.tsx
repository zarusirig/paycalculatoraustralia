...
const faq: WithContext<FAQPage> = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Have tax brackets changed for FY2025-26?", acceptedAnswer: { "@type": "Answer", text: "No. The FY2025-26 tax brackets are the same as FY2024-25: 0% up to $18,200, 16% from $18,201-$45,000, 30% from $45,001-$135,000, 37% from $135,001-$190,000, and 45% above $190,000." } },
