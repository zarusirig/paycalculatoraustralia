...
const faq: WithContext<FAQPage> = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "What is the maximum I can salary sacrifice into super?", acceptedAnswer: { "@type": "Answer", text: "The concessional contributions cap is $32,500 per year for FY2026-27 (it was $30,000 in FY2025-26), which includes both employer SG contributions and salary sacrifice amounts. Unused cap amounts from the previous 5 years can be carried forward if your total super balance is under $500,000." } },
