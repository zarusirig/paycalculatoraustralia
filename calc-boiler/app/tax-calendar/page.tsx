...
import { TAX_CALENDAR_FAQS } from "@/modules/guide/tax-calendar-faqs";
...
const DESCRIPTION = `Every key tax date for ${CALENDAR_YEAR.incomeYear}: ${RETURN_2026.incomeYear} tax returns due ${RETURN_2026.selfLodgeDueDate} (${RETURN_2026.agentDueDateMostPeople} via an agent), quarterly BAS and PAYG instalments, and Payday Super deadlines.`;
...
function Page() { return (<><JsonLd code={[breadcrumb, webPage, faqPageSchema(TAX_CALENDAR_FAQS)]} /><TaxCalendarPage /></>); }

export default withPageEnd(Page, "/tax-calendar/");
