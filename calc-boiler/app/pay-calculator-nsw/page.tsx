...
import { NSW_FAQS } from "@/modules/state/pay-calculator-nsw-faqs";
...
const webAppSchema: WithContext<WebApplication> = {
  ...
  dateModified: pageDateModified("pay-calculator-nsw"),
  inLanguage: "en-AU",
};

const faq = faqPageSchema(NSW_FAQS);
...
export default withPageEnd(Page, "/pay-calculator-nsw/");
