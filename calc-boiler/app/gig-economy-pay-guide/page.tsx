...
export const metadata: Metadata = { title: "Gig Economy Tax Guide — Uber, Deliveroo & Freelance Pay", description: "Gig worker tax guide: ABN obligations, GST registration, quarterly BAS, deductions for rideshare, delivery, and freelance work. How to manage tax when you're your own boss.", alternates: { canonical: URL }, openGraph: { title: "Gig Economy Tax Guide Australia", description: "Tax & pay guide for Uber, delivery, and freelance workers in Australia.", url: URL, siteName: SITE_CONFIG.name, type: "website", locale: "en_AU" }, twitter: { card: "summary_large_image", title: "Gig Economy Tax Guide Australia", description: "ABN, GST, BAS and deductions for gig workers." } };
