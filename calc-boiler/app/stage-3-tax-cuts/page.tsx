...
export const metadata: Metadata = { title: "Stage 3 Tax Cuts Explained — Before & After (FY2024-25)", description: "How the revised Stage 3 tax cuts affect your pay. Before and after comparison at every income level. See exactly how much more you take home under the new tax brackets.", alternates: { canonical: URL }, openGraph: { title: "Stage 3 Tax Cuts Explained", description: "Before & after comparison of the revised Stage 3 tax cuts at every income level.", url: URL, siteName: SITE_CONFIG.name, type: "website", locale: "en_AU" }, twitter: { card: "summary_large_image", title: "Stage 3 Tax Cuts Explained", description: "See how much more you take home under the revised Stage 3 tax cuts." } };
