...
const TITLE = `HECS Repayment Calculator ${SITE_CONFIG.financialYear} — All Study Loans`;
const DESCRIPTION = `Work out your compulsory study loan repayment for ${SITE_CONFIG.financialYear}. One threshold of ${formatAUD(T)} covers HELP, VSL, SFSS, SSL, ABSTUDY SSL and AASL — with the full ATO rate table and the order the ATO pays each loan off.`;
