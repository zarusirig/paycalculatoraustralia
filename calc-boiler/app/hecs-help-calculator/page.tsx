...
const faq: WithContext<FAQPage> = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
  { "@type": "Question", name: "At what income do HECS repayments start in 2026-27?",
    acceptedAnswer: { "@type": "Answer", text: "Compulsory HECS repayments start once your repayment income exceeds $69,528 in FY2026-27 (up from $67,000 in FY2025-26). At or below $69,528, you make no compulsory repayment." } },
