...
function Page() {
  return (
    <>
      ...
      <CarerAllowancePage afterCalculator={<WhatsNextInline route="/carer-allowance/" />}><CarerAllowanceContent /></CarerAllowancePage>
    </>
  );
}

export default withPageEnd(Page, "/carer-allowance/");
