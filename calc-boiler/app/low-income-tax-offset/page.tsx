...
const DESCRIPTION = "Calculate your exact LITO amount for FY2026-27. See the $700 max offset, the $37,500–$66,667 phase-out, and how much tax you actually save — with examples by income.";
...
const faq: WithContext<FAQPage> = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "How much is the Low Income Tax Offset for 2026-27?", acceptedAnswer: { "@type": "Answer", text: "$700 maximum for taxable income up to $37,500." } },
    { "@type": "Question", name: "At what income does LITO phase out?", acceptedAnswer: { "@type": "Answer", text: "Phases out from $37,500 (5c/$) and is fully gone at $66,667." } },
    { "@type": "Question", name: "Do I need to apply for LITO?", acceptedAnswer: { "@type": "Answer", text: "No — the ATO applies it automatically when you lodge your tax return." } },
    { "@type": "Question", name: "What's the difference between LITO and LMITO?", acceptedAnswer: { "@type": "Answer", text: "LMITO was abolished after FY2021-22. Only LITO ($700 max) applies for FY2026-27." } },
