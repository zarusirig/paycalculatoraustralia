...
const faq: WithContext<FAQPage> = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "How much is the Low Income Tax Offset for 2025-26?", acceptedAnswer: { "@type": "Answer", text: "$700 maximum for taxable income up to $37,500." } },
    ...
    { "@type": "Question", name: "What's the difference between LITO and LMITO?", acceptedAnswer: { "@type": "Answer", text: "LMITO was abolished after FY2021-22. Only LITO ($700 max) applies for FY2025-26." } },
