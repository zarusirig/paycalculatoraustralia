...
const faq: WithContext<FAQPage> = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How is HECS-HELP debt indexed?", acceptedAnswer: { "@type": "Answer", text: "HECS-HELP debt is indexed annually on 1 June to the lower of CPI or the Wage Price Index (WPI). This cap was legislated in 2024 and applied from 1 June 2023 to prevent debt growing faster than wages; indexation on 1 June 2026 was 2.8%." } },
