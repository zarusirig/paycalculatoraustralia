...
export const metadata: Metadata = { title: "Non-Resident Tax Rates Australia — Foreign Resident Guide", description: "Non-resident tax rates: no tax-free threshold, 30% from dollar one. Comparison table resident vs non-resident. Foreign resident tax guide.", alternates: { canonical: URL }, openGraph: { title: "Non-Resident Tax Rates Australia", description: "Tax rates for foreign residents with comparison tables.", url: URL, siteName: SITE_CONFIG.name, type: "website", locale: "en_AU", images: ["/og-image.png"] }, twitter: { card: "summary_large_image", title: "Non-Resident Tax Guide", description: "Foreign resident tax rates and comparison." } };
...
const faq = faqPageSchema(NON_RESIDENT_FAQS);
function Page() { return (<><JsonLd code={[breadcrumb, webPage, faq]} /><NonResidentTaxPage /></>); }

export default withPageEnd(Page, "/non-resident-tax/");
