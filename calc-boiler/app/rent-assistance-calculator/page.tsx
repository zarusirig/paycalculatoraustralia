...
function Page() {
  return (
    <>
      ...
      <RentAssistanceCalculatorPage afterCalculator={<WhatsNextInline route="/rent-assistance-calculator/" />}><RentAssistanceCalculatorContent /></RentAssistanceCalculatorPage>
    </>
  );
}
